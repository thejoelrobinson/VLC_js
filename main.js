...
function createHandlers() {
    ...
    const inputElement = document.getElementById("fpicker_btn");
    inputElement.addEventListener("change", handleFiles);
    let media_player;
    const options_input = document.getElementById("opts");
    ...
    const view_vlc_argv = new Uint32Array(window.Module.wasmMemory.buffer, vlc_argv, vlc_opts_array.length);
    wrote_size = 0;
    for (let i = 0; i < vlc_opts_array.length; i++) {
