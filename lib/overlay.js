...
export function update_overlay(overlay) {
  ...
  let is_paused = !window._vlcIsPlaying;
  ...
  progressCurrent.closest('[role="slider"]')?.setAttribute('aria-valuenow', Math.round(progressPosition));
  ...
  progressCurrentVolume.closest('[role="slider"]')?.setAttribute('aria-valuenow', isMuted ? 0 : volume);
