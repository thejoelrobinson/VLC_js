...
void PROGRESS_BAR_COLOR;
void PROGRESS_BAR_BG_COLOR;
void VOLUME_BAR_COLOR;
void VOLUME_BAR_MUTE_COLOR;
void VOLUME_BAR_BG_COLOR;
void BUTTON_BG_COLOR;
void GENERAL_BG_COLOR;
void TEXT_COLOR;
void MENU_BAR_HEIGHT;
void central_play_icon;
void play_button;
void pause_button;
void volume_button;
void muted_button;
// Apply underlying changes (eg video is paused) to the displayed UI
export function update_overlay() {
...
export function on_overlay_click(_mouseEvent) {
}
